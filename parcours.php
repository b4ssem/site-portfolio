...
<h1 class="text-3xl font-bold text-left mb-6">Mon Parcours</h1>
  ...
  <div class="flex flex-col gap-2">
    ...
    <ul class="list-disc pl-5 text-sm text-gray-700 space-y-1">
      ...
      <li>Parcours développement web et médias interactifs</li>
    </ul>
  </div>
</div>
...
<div class="reveal1 bg-white p-6 rounded-lg shadow-md fade-in flex gap-4 items-start">
  ...
  <div class="flex flex-col gap-2">
    <div>
      <h3 class="text-lg font-semibold text-gray-800">BAC Général - Lycée Jean Jacques Rousseau (Montmorency)</h3>
      <p class="text-sm text-gray-600">2021 - 2024</p>
    </div>
    <ul class="list-disc pl-5 text-sm text-gray-700 space-y-1">
      <li>Spécialités NSI et LLCER</li>
